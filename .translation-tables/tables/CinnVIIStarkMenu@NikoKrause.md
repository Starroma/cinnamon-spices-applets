...
<p>
  <a href="../tables/README.md">Applets</a> &#187; <b>CinnVIIStarkMenu@NikoKrause</b>
</p>
  ...
  <tbody>
    <tr>
      ...
      <td class="idpo" data-value="cs">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/cs.po">cs.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="da">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/da.po">da.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="de">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/de.po">de.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="es">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/es.po">es.po</a>
      </td>
      <td class="status" data-value="90">
        <img src="http://progressed.io/bar/90" alt="90%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="fr">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/fr.po">fr.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="hr">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/hr.po">hr.po</a>
      </td>
      <td class="status" data-value="90">
        <img src="http://progressed.io/bar/90" alt="90%" />
      </td>
    ...
    <tr>
      <td class="language" data-value="Kurdish">
        <a href="../tables/ku.md">Kurdish</a>
      </td>
      <td class="idpo" data-value="ku">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/ku.po">ku.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="pt">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/pt.po">pt.po</a>
      </td>
      <td class="status" data-value="90">
        <img src="http://progressed.io/bar/90" alt="90%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="ro">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/ro.po">ro.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="ru">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/ru.po">ru.po</a>
      </td>
      <td class="status" data-value="90">
        <img src="http://progressed.io/bar/90" alt="90%" />
      </td>
    ...
    <tr>
      <td class="language" data-value="Serbian">
        <a href="../tables/sr.md">Serbian</a>
      </td>
      <td class="idpo" data-value="sr">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/sr.po">sr.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="sv">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/sv.po">sv.po</a>
      </td>
      <td class="status" data-value="90">
        <img src="http://progressed.io/bar/90" alt="90%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="zh_CN">
        <a href="../po/CinnVIIStarkMenu@NikoKrause/zh_CN.po">zh_CN.po</a>
      </td>
      <td class="status" data-value="90">
        <img src="http://progressed.io/bar/90" alt="90%" />
      </td>

...
<p>
  <a href="tables/README.md">Applets</a> &#187; <b>officeCenter@scollins</b>
</p>
  ...
  <tbody>
    <tr>
      ...
      <td class="idpo" data-value="da">
        <a href="po/officeCenter@scollins/da.po">da.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="de">
        <a href="po/officeCenter@scollins/de.po">de.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="hr">
        <a href="po/officeCenter@scollins/hr.po">hr.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="sv">
        <a href="po/officeCenter@scollins/sv.po">sv.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="tr">
        <a href="po/officeCenter@scollins/tr.po">tr.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="zh_CN">
        <a href="po/officeCenter@scollins/zh_CN.po">zh_CN.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>

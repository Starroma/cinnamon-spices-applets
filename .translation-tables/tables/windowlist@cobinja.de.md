...
<p>
  <a href="../tables/README.md">Applets</a> &#187; <b>windowlist@cobinja.de</b>
</p>
  ...
  <tbody>
    <tr>
      ...
      <td class="idpo" data-value="de">
        <a href="../po/windowlist@cobinja.de/de.po">de.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="hr">
        <a href="../po/windowlist@cobinja.de/hr.po">hr.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="pl">
        <a href="../po/windowlist@cobinja.de/pl.po">pl.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="sv">
        <a href="../po/windowlist@cobinja.de/sv.po">sv.po</a>
      </td>
      <td class="status" data-value="66">
        <img src="http://progressed.io/bar/66" alt="66%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="zh_CN">
        <a href="../po/windowlist@cobinja.de/zh_CN.po">zh_CN.po</a>
      </td>
      <td class="status" data-value="68">
        <img src="http://progressed.io/bar/68" alt="68%" />
      </td>

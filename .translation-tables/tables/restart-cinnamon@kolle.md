...
<p>
  <a href="../tables/README.md">Applets</a> &#187; <b>restart-cinnamon@kolle</b>
</p>
  ...
  <tbody>
    <tr>
      ...
      <td class="idpo" data-value="de">
        <a href="../po/restart-cinnamon@kolle/de.po">de.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="hr">
        <a href="../po/restart-cinnamon@kolle/hr.po">hr.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="sv">
        <a href="../po/restart-cinnamon@kolle/sv.po">sv.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="zh_CN">
        <a href="../po/restart-cinnamon@kolle/zh_CN.po">zh_CN.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>

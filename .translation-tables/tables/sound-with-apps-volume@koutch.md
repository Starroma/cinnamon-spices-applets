...
<p>
  <a href="../tables/README.md">Applets</a> &#187; <b>sound-with-apps-volume@koutch</b>
</p>
  ...
  <tbody>
    <tr>
      ...
      <td class="idpo" data-value="hr">
        <a href="../po/sound-with-apps-volume@koutch/hr.po">hr.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="ru">
        <a href="../po/sound-with-apps-volume@koutch/ru.po">ru.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="sv">
        <a href="../po/sound-with-apps-volume@koutch/sv.po">sv.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="zh_CN">
        <a href="../po/sound-with-apps-volume@koutch/zh_CN.po">zh_CN.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>

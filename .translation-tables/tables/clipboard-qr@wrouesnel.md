...
<p>
  <a href="../tables/README.md">Applets</a> &#187; <b>clipboard-qr@wrouesnel</b>
</p>
  ...
  <tbody>
    <tr>
      ...
      <td class="idpo" data-value="da">
        <a href="../po/clipboard-qr@wrouesnel/da.po">da.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="de">
        <a href="../po/clipboard-qr@wrouesnel/de.po">de.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="hr">
        <a href="../po/clipboard-qr@wrouesnel/hr.po">hr.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="sv">
        <a href="../po/clipboard-qr@wrouesnel/sv.po">sv.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="zh_CN">
        <a href="../po/clipboard-qr@wrouesnel/zh_CN.po">zh_CN.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>

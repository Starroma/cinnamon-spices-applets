...
<p>
  <a href="../tables/README.md">Applets</a> &#187; <b>download-and-upload-speed@cardsurf</b>
</p>
  ...
  <tbody>
    <tr>
      ...
      <td class="idpo" data-value="da">
        <a href="../po/download-and-upload-speed@cardsurf/da.po">da.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="de">
        <a href="../po/download-and-upload-speed@cardsurf/de.po">de.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="hr">
        <a href="../po/download-and-upload-speed@cardsurf/hr.po">hr.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="sv">
        <a href="../po/download-and-upload-speed@cardsurf/sv.po">sv.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="zh_CN">
        <a href="../po/download-and-upload-speed@cardsurf/zh_CN.po">zh_CN.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>

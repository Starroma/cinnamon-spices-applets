...
<p>
  <a href="../tables/README.md">Applets</a> &#187; <b>hwmonitor@sylfurd</b>
</p>
  ...
  <tbody>
    <tr>
      ...
      <td class="idpo" data-value="da">
        <a href="../po/hwmonitor@sylfurd/da.po">da.po</a>
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="de">
        <a href="../po/hwmonitor@sylfurd/de.po">de.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="ru">
        <a href="../po/hwmonitor@sylfurd/ru.po">ru.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="sv">
        <a href="../po/hwmonitor@sylfurd/sv.po">sv.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>
    ...
    <tr>
      ...
      <td class="idpo" data-value="zh_CN">
        <a href="../po/hwmonitor@sylfurd/zh_CN.po">zh_CN.po</a>
      </td>
      <td class="status" data-value="100">
        <img src="http://progressed.io/bar/100" alt="100%" />
      </td>

...
[Applets](../../../README.md) &#187; [Cinnamenu@json](../README.md) &#187; ** (fr_FR)**
      ...
      34	columns
      35	Startup applications view mode
      36	Set the custom menu button icon name
      37	Open the menu when I move my mouse over it
      38	Enable opening the menu when the mouse enters the applet
      39	Scale grid icons by available space
      40	This makes the grid icon size variable depending on how many apps are being shown. This overrides the grid icon size option.
